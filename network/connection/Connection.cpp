...
void Connection::handle_read( const Connection::error_code &e, std::size_t bytes_transferred )
{
    ...
    {
        to_put_in_loop.insert(std::pair<string, string>("path","GET"));
    ...
    if ( request.get_action() == "LOGIN_GET") // получить страницу входа
        to_put_in_loop.insert(std::pair<string, string>("path","LOGIN"));
    ...
    if ( request.get_action() == "SIGNUP_GET") // получить страницу регистрации
        to_put_in_loop.insert(std::pair<string, string>("path","SIGNUP"));
    ...
    {
        to_put_in_loop.insert(std::pair<string, string>("path","FILES_BY_TAG"));
    ...
    {
        to_put_in_loop.insert(std::pair<string, string>("path","ADD_FILE"));
        to_put_in_loop.insert(std::pair<string, string>("tag",request.get_data((string &) "tag")));
        to_put_in_loop.insert(std::pair<string, string>("session",request.get_cookie((string &) "session")));
